...
import { Send, Menu, GripVertical } from 'lucide-react';
      ...
      <Sheet open={isMobileSidebarOpen} onOpenChange={setIsMobileSidebarOpen}>
       ...
       <div className='flex-1 flex flex-col main-content-container'>
         ...
         <div className='md:hidden flex items-center gap-2 p-4 border-b'>
          ...
          {/* Chat Section */}
          <div 
            className='flex flex-col min-h-0 relative bg-gray-100 dark:bg-gray-900'
         ...
         {/* Resizable Divider */}
         <div 
           className={`h-1 bg-border hover:bg-primary/50 cursor-row-resize flex items-center justify-center group transition-colors ${
